...
window.PDFObject = function (obj) {
    ...
    hasReader = function () {
        ...
        var i,
            n = navigator.plugins,
            count = n.length,
            regx = /Adobe Reader|Adobe PDF|Shockwave Flash|Acrobat/gi;
    ...
    pluginFound = function () {
        ...
        if (!!(window.ActiveXObject || 'ActiveXObject' in window) && hasReaderActiveX()) {
    ...
    embed = function (targetID) {
        ...
        // targetNode.innerHTML = '<div id="contextmenuPop" style="width: '+ width + '; height:'+ height +';display: none; top: 26px; left: 300px;z-index:9999">';
        // targetNode.innerHTML += '<object  style="position:absolute;z-index:900"  data="' + url + '" type="application/pdf" width="' + width + '" height="' + height + '">'+ 
        //   '<param name="wmode" value="transparent" />'+
        //  +'</object>';
        //  targetNode.innerHTML+= '<iframe src="" frameBorder="0" marginHeight="0" marginWidth="0" style="position:absolute;visibility:inherit;top:0px;left:0px;width:200px;height:200px;'+
        //  　　　　　　　　'z-index:-1;filter:alpha(opacity=0);"></iframe>';
        //  targetNode.innerHTML+= '</div>';
        targetNode.innerHTML = '<object  style="position:absolute;z-index:900"  data="' + url + '" type="application/pdf" width="' + width + '" height="' + height + '"></object>';
    ...
    window.PDFObject.get = function (prop) {
        return get(prop);
    };
    window.PDFObject.embed = function (id) {
        return embed(id);
    };
    window.PDFObject.pdfobjectversion = pdfobjectversion;
