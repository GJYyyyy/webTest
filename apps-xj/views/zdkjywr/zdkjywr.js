...
var zdkjywrApi = {
    getGridData: "/dzgzpt-wsys/api/xj/wtgl/dbsx/queryTbDbsx"// 查询
};
var zdkjywrObj = {
    exportData: '',
    key: true, // 防止多次点击
    ...
    sdrqZ: null,
    param: null,
    blztDm: [{ 'ID': '00', 'value': '待受理' }],
    blztList: [{ 'ID': 'all', 'value': '所有' }, { 'ID': '00', 'value': '待受理' }, { 'ID': '01', 'value': '受理通过' }, { 'ID': '02', 'value': '不予受理' }, { 'ID': '06', 'value': '补正资料' }, { 'ID': '11', 'value': '已撤销申请' }, { 'ID': '99', 'value': '异常终止' }],
    init: function () {
        ...
        this.blztDm.setValue([{ 'ID': '00', 'value': '待受理' }]);
        this.changeOther();
        this.doSearch()
    },
