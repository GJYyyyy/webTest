...
var xbnsrcx = {
    ...
    changeOther: function (option) {
        if(option === 'reset') {
            ...
            this.sqrqq.setValue(mini.formatDate(now,'yyyy-MM-dd'));
    ...
    showSwsxSqxx: function (lcslId, sqlybj, blztDm,rwbh,slsj,sqlymc) {
        mini.mask({cls: 'mini-mask-loading', message: '处理中，请稍候...'});
        mini.Cookie.set("lcslId", lcslId);
        var url = "xbnsrtcSl.html?lcslId=" + lcslId + "&isYct=" + sqlybj + "&rwbh=" + rwbh + '&slsj=' + slsj + '&sqlymc=' + encodeURIComponent(sqlymc);
    ...
    onActionRenderer: function (e) {
        ...
        // }
        return '<a class="Delete_Button" onclick="xbnsrcx.showSwsxSqxx(\'' + lcslId
                + '\',\'' + sqlybj + '\',\'' + blztDm + '\',\'' + rwbh + '\',\'' + slsj + '\',\'' + sqlymc + '\')" href="#">查看</a>';
        // } else {
        //     return '<a class="Delete_Button" onclick="xbnsrcx.showSwsxSqxx(\'' + lcslId
