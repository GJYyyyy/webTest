    ...
    if (!!data) {
        ...
        if(tabs){
            ...
            if ($.inArray(data.swsxDm,['110113','110133','110212','110213','110214','110207','110208','200006',
                '200007','200001','110418'])>-1) {//外经证申报则不显示第二个tab页
                tabs.removeTab(1);
            }
            // 操作按钮显示初始化
...
sxslcommon.sxbj = function () {
    ...
    if (storeObj.swsxDm === '110418') {
        mini.showMessageBox({
            title: '提示',
            message: '是否已在金三完成“开具无欠税证明”的录入与打印？',
            buttons: ["是", "否"],
...
sxslcommon.shbj = function () {
    ...
    } else if (storeObj.swsxDm === '130102') {
        mini.showMessageBox({
            title: '提示',
            message: '请到金三前台手动修改金三税（费）种信息中的土地增值税预缴征收率',
            buttons: ["取消", "已完成"],
            callback: function (action) {
                if (action === '取消') {
                    //
...
function displayButton(swsxDm, sxshfsDm) {
    ...
    if (WSYS_SLSHFS_DM.SLSHFS_JB == sxsl_store.sxshfsDm) {
        ...
        if (!(swsxDm == "110113" || swsxDm == "110133" || swsxDm == "110212"|| swsxDm == "110213"|| swsxDm == "110214" || swsxDm == "110805" || swsxDm == "110806" || swsxDm == '110403' || swsxDm == '130101' || swsxDm == "110418")) {//外经证申报不显示补正资料
