...
var ghqc = {
    swjgDm: '',
    searchUrl: '/dzgzpt-wsys/api/wtgl/sbtc/getYsbGhqcGroupByZgy',
    init: function () {
    ...
    swjgRender: function (e) {
        if (!e.record.ssglyDm) {
            return '<a class="txt-blue" href="ghqccx.html?swjgDm='+ ghqc.swjgDm +'">'+e.record.swryxm+'</a>';
        } else {
            return '<a class="txt-blue" href="ghqccx.html?ssglyDm='+ e.record.ssglyDm +'">'+e.record.swryxm+'</a>';
        }
    },
