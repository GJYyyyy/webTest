    ...
    if(flag){
        ...
        mini.open({
            ...
            ondestroy : function(action) {
                ...
                if ("ok" == action || "ok" == action.status) {
                    var swsxIframe = this.getIFrameEl();
                    sxsl_store.xbtcDjxh = swsxIframe.contentWindow.SWSX_STORE.djxh;
                    mini.get("backBtn").doClick();
                }
            }
        });
